...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python script.py "What is Python?"
  python script.py "Explain AI" --model deepseek
  python script.py "Explain AI" --model "deepseek/deepseek-chat-v3.1:free"
  python script.py "Write a poem" --system "You are a creative poet" --temp 1.5 -m llama
